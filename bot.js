...
var ms = 10000 ;
var setGame = [`${prefix}help | ${client.user.username} on ${client.guilds.size} Servers!`,`${prefix}help | ${client.user.username} has ${client.users.size} Users!`];
var i = -1;
var j = 0;
...
j = -1;
 ...
 i = i+j;
client.user.setGame(setGame[i],`https://www.twitch.tv/tgs_himo`);
}, ms);
...
const developers = ["550455195704885258"]
client.on('message', message => {
